...
@LargeTest
public class TestB1033 extends BaristaTest<Activity> {
  public TestB1033() {
  ...
  public void testB1033() {
    ...
    onView(ViewMatchers.withId("org.epstudios.epmobile.R.id.text_button")).check(ViewAssertions.matches(ViewMatchers.withText("Notes")));
  }
}
